...
namespace WeP_BAL
{
    public static class Helper
    {
        ...
        public static void EWB_DataAdapterData(string strGSTINNo, out string strUsername, out string strAppKey, out string strEncryptedSek, out string strAuthToken, out string CustId, out string UserId)
        {
            string Username = "", AppKey = "", EncryptedSEK = "", AuthToken = "",custId="",userId="" ;
            string connectionString = ConfigurationManager.AppSettings["ConnectionString"];
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                con.Open();
