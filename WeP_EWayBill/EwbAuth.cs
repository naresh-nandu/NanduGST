...
namespace WeP_EWayBill
{
    public class EwbAuth
    {
        ...
        {
            string EWBAuthResponse = "", EncryptedAppKey = "", Username = "", EncryptedPassword = "", ErrorDescription = "";
            try
            {
                Helper.EWB_AUTH_DataAdapter(strGSTINNo, out Username, out EncryptedAppKey, out EncryptedPassword);

                EwbRequestAttributes objEWBAuth = new EwbRequestAttributes();
                ...
                var data = JsonConvert.DeserializeObject<EwbResponseAttributes>(EWBAuthResponse);
                ...
                {
                    var root = JsonConvert.DeserializeObject<EwbResponseAttributes>(EWBAuthResponse);
