...
namespace GSTR2Download
{
    ...
    public List<B2BA_Itm> itms { get; set; }
    }

    public class B2BA_Itm
    {
    public int num { get; set; }
    public B2BA_ItmDet itm_det { get; set; }
    public B2BA_Itc itc { get; set; }
    }

    public class B2BA_ItmDet
    {
