<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerDocuments.aspx.cs" Inherits="SmartAdminMvc.CustomerDocuments" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered table-hover"
                HorizontalAlign="Justify" DataKeyNames="UploadFileId" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
