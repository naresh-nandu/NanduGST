        ...
        public string SendRequest(DataTable data)
        {
            try
            {
                ...
                if (data.Rows.Count > 0)
                {
                    ...
                    {
                        SqlDataAdapter adt = new SqlDataAdapter("Select * from TBL_BP_GSTR2_B2B_INV where num = '" + data.Rows[i][2].ToString() + "' and dt = '" + data.Rows[i][3].ToString() + "'", con);
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            BPInv_Itms_Response = Common.Functions.InsertIntoTable("TBL_BP_GSTR2_B2B_INV_ITMS", cmd, con);
                        }
                        else
                        {
                            cmd.Parameters.Clear();
                            ...
                            BPInv_Response = Common.Functions.InsertIntoTable("TBL_BP_GSTR2_B2B_INV", cmd, con);
