        ...
        public string SendRequest(DataTable data)
        {
            try
            {
                ...
                if (data.Rows.Count > 0)
                {
                    ...
                    {
                        SqlDataAdapter adt = new SqlDataAdapter("Select * from TBL_BP_GSTR1_B2BA_INV where num = '" + data.Rows[i][4].ToString() + "' and dt = '" + data.Rows[i][4].ToString() + "'", con);
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            BPInv_Itms_Response = Common.Functions.InsertIntoTable("TBL_BP_GSTR1_B2BA_INV_ITMS", cmd, con);
                        }
                        else
                        {
                            cmd.Parameters.Clear();
                            ...
                            BPInv_Response = Common.Functions.InsertIntoTable("TBL_BP_GSTR1_B2BA_INV", cmd, con);
