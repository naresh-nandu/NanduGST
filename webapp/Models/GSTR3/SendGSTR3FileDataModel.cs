...
{
    public class SendGSTR3FileDataModel
    {
        ...
        public string SendRequest(string JsonData, string GSTINNo, string Period, string SessionUserId, string SessionCustId, string SessionUsername)
        {
            try
            {
                ...
                GSTR3FileParameters objGSTR3FileParams = new GSTR3FileParameters();
                objGSTR3FileParams.data = encryptedpayload;
                objGSTR3FileParams.hmac = encryptedhmac;
                objGSTR3FileParams.action = "RETSUBMIT";

                string tempjsondata = new JavaScriptSerializer().Serialize(objGSTR3FileParams);
                ...
                if (status_response == "1")
                {
                    ...
                    cmd.Parameters.Add("@Audit_Message", SqlDbType.VarChar).Value = "GSTR3 Filed";
                    ...
                    Common.Notification.SendSMS(strMobileNo, string.Format("GSTR-3 Filed Successfully"));
                    return "GSTR3 Filed Successfully... Status - " + laststatus_response + " and Ack No. - " + Acknum_response;
    ...
    public class GSTR3FileParameters
    {
