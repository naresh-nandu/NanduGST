...
{
    public partial class Delete_GSTR1_SA
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["ConnectionString"]);
        string RefIds = "";
        public void GSTR1Delete(string strActionType, int[] ids)
        {
            try
            {
                con.Open();
                ...
                {
                    SqlCommand cmd = new SqlCommand("usp_Delete_GSTR1_SA", con);
        ...
        public void GSTR1_Checksum_Calculation(string strActionType, string StrGSTINNo, string strPeriod, string strRefIds)
        {
            try
            {
