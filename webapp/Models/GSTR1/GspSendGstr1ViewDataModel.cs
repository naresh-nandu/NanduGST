...
{
    public class GspSendGstr1ViewDataModel
    {
        public string SendRequest(string JsonData, string strAction, string GSTINNo, string Period, string SessionUserId, string SessionCustId, string SessionUsername)
        {
            ...
            try
            {
                ...
                GstRequestResponseAttributes objGSTR1ViewParams = new GstRequestResponseAttributes();
                ...
                if (status_response == "1")
                {
                    ...
                    Gstr1Retstatus.Update_GSTR1_RetStatus(GSTINNo, Period, refid_response, strAction, "", "1", "", SessionCustId, SessionUserId);

                    
                    new GspGetGstr1ViewDataModel(SessionCustId, SessionUserId, SessionUsername).SendRequest(strAction, GSTINNo, Period, "RETSTATUS", refid_response);
