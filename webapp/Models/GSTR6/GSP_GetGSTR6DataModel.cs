...
{
    public partial class GSP_GetGSTR6DataModel
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["ConnectionString"]);
        //string DownloadPath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + @"\Downloads";
       
        private static string GSTR6_Download_Response = "";
        ...
        public string SendRequest6(string strGSTINNo, string strPeriod, string strAction, string strCTIN, string strRefId, string strToken, string SessionUserId, string SessionCustId, string SessionUsername)
        {
