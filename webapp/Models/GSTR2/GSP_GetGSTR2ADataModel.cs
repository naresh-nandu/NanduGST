...
{
    public partial class GSP_GetGSTR2ADataModel
    {
        ...
        public string SendRequest(string strGSTINNo, string strPeriod, string strAction, string strToken, string from, string to,string SessionUserId, string SessionCustId, string SessionUsername)
        {
            ...
            try
            {
                ...
                else
                {
                        ...
                        Helper.InsertAuditLog(SessionUserId, SessionUsername, "GSTR-2A " + action + " " + root.error.message + " for this " + strGSTINNo + " and " + strPeriod + " to " + to, "");
                        Helper.InsertAPICountTransactions(strGSTINNo, strPeriod, "GSTR2A DOWNLOAD", SessionUserId, SessionCustId);
            ...
            try
            {
                ...
                if (status_response == "1")
                {
                    ...
                    if (stringUrls[1] != "urls" && stringUrls[1] != "b2b" && stringUrls[1] != "cdn")
                    {
                        ...
                        string Message = "GSTR-2A " + action + " Downloaded Successfully for this " + strGSTINNo + " and " + strPeriod + " to " + to +", Token for Large File - " + token_response;
                ...
                else if (status_response == "2")
                {
                    ...
                    string Message = "GSTR-2A " + action + " Downloaded Successfully for this " + strGSTINNo + " and " + month1 + ", Token for Large File - " + token_response;
                    Helper.InsertAuditLog(SessionUserId, SessionUsername, Message, "");
                ...
                else
                {
                    ...
                    string Message = "GSTR-2A " + action + " " + root.error.message + " for this " + strGSTINNo + " and " + from + " to " + to ;
