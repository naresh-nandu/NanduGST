...
namespace SmartAdminMvc
{
    public static class BundleConfig
    {
        ...
        {
            bundles.Add(new StyleBundle(ConfigurationManager.AppSettings["Bundle_content_smartadmin"]).IncludeDirectory(ConfigurationManager.AppSettings["Bundle_content_css"], "*.min.css"));

            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_smartadmin"]).Include(
            ...
            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_full_calendar"]).Include(
                "~/scripts/plugin/moment/moment.min.js",
                "~/scripts/plugin/fullcalendar/jquery.fullcalendar.min.js"
                ));

            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_charts"]).Include(
            ...
            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_datatables"]).Include(
            ...
            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_jq_grid"]).Include(
                "~/scripts/plugin/jqgrid/jquery.jqGrid.min.js",
                "~/scripts/plugin/jqgrid/grid.locale-en.min.js"
                ));

            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_forms"]).Include(
                "~/scripts/plugin/jquery-form/jquery-form.min.js"
                ));

            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_smart_chat"]).Include(
                "~/scripts/smart-chat-ui/smart.chat.ui.min.js",
                "~/scripts/smart-chat-ui/smart.chat.manager.min.js"
                ));

            bundles.Add(new ScriptBundle(ConfigurationManager.AppSettings["Bundle_scripts_vector_map"]).Include(
