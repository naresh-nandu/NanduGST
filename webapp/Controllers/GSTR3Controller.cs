...
namespace SmartAdminMvc.Controllers
{
    ...
    public class Gstr3Controller : Controller
    {
        ...
        public ActionResult Save(int page = 0, string sort = null)
        {
            ...
            if (sort != null || page != 0)
            {
                ...
                TempData.Keep();
                SelectList Actionlst = new SelectList(db.TBL_GSTR_ACTION_TYPE.Where(o => o.GSTRType == "GSTR3"), "ActionId", "ActionName", Convert.ToString(strActionId));
                ...
                var GridFill = Gstr3DataModel.GetListGSTR3Save(strGSTINNo, strAction);
                return View(GridFill);
            }
            else
            {
                SelectList Actionlst = new SelectList(db.TBL_GSTR_ACTION_TYPE.Where(o => o.GSTRType == "GSTR3"), "ActionId", "ActionName");
                ViewData["ActionList"] = Actionlst;
                ViewBag.ActionList = Actionlst;
        ...
        public ActionResult Save(FormCollection frm, string GSTR3Save, string OTPSubmit)
        {
            if (!Request.IsAuthenticated)
            {
                return RedirectToAction("Login", "Account");
            ...
            if (!string.IsNullOrEmpty(GSTR3Save))
            {
                TempData["SaveResponse"] = "GSTR3 Saved Successfully... Trans Id - TXOID0000000011 and Ref Id - LAPN24235325555";
            ...
            else
            {
                ...
                ViewBag.TitleHeaders = "GSTR-3 Save - [" + strAction + "]";
                var GridFill = Gstr3DataModel.GetListGSTR3Save(strGSTINNo, strAction);
                return View(GridFill);
            }
        }
        ...
        public ActionResult File(int page = 0, string sort = null)
        {
            ...
            if (sort != null || page != 0)
            {
                ...
                var GridFill = Gstr3DataModel.GetListGSTR3File(strGSTINNo, strAction, strFp);
                return View(GridFill);
            }
            else
            {
        ...
        [System.Web.Mvc.HttpPost]
        [System.Web.Mvc.AcceptVerbs(HttpVerbs.Post)]
        public ActionResult File(FormCollection frm, string ESign, string GSTR3File, string OTPSubmit)
        {
            if (!Request.IsAuthenticated)
            {
                return RedirectToAction("Login", "Account");
            ...
            if (!string.IsNullOrEmpty(GSTR3File))
            {
                string strJsonData = Gstr3DataModel.GetJsonGSTR3Save(strAction, strGSTINNo, strFp);
            ...
            {
                TempData["FileResponse"] = "GSTR3 Filed Successfully... Status - SUCCESS and Ack No. - ASDFSDF1241343";
            ...
            {
                ViewBag.TitleHeaders = "GSTR-3 File - [" + strAction + "]";
                var GridFill = Gstr3DataModel.GetListGSTR3File(strGSTINNo, strAction, strFp);
