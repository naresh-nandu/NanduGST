...
namespace SmartAdminMvc.Controllers
{
    ...
    public class Gstr3DownloadController : Controller
    {
        // GET: GSTR3Download
        ...
        public ActionResult Index(FormCollection frm, string Download, string Export)
        {
            ...
            try
            {
                ...
                {
                    ViewBag.GSTINNoList = LoadDropDowns.GSTIN_No(iUserId, iCustId, Session["Role_Name"].ToString());
                    ViewBag.DownloadResponse = "GSTR3 Downloaded Successfully";

                    var GridFill = GetListGSTR3Download(GSTIN, Action);
                    var ds = GetDatatableGSTR3Download(GSTIN, Action);
                ...
                else if (!string.IsNullOrEmpty(Export))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment; filename=GSTR3_Download.xls");
        ...
        public static List<IDictionary> GetListGSTR3Download(string GSTINNo, string ActionType)
        {
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["ConnectionString"]))
            {
                try
                {
                    #region commented
                    conn.Open();
                    SqlCommand dCmd = new SqlCommand("Retrieve_Download_GSTR3_ByAction", conn);
        ...
        public static DataTable GetDatatableGSTR3Download(string GSTINNo, string ActionType)
        {
