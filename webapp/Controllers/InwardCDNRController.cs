...
namespace SmartAdminMvc.Controllers
{
    ...
    public class InwardCDNRController : Controller
    {
        ...
        public ActionResult Home(FormCollection form)
        {
            ...
            //db.Ins_Inward_Gstr2_CDNR(name, gstin, custid, cgstin, notetype, notenum, notedate, rns, revinvoice, reviseddate, reversecharge, taxvalue, igstr, igsta, cgstr, cgsta, sgstr, sgsta, cessr, cessa, elig, userid);
            db.SaveChanges();
