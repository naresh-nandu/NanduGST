...
namespace SmartAdminMvc.Controllers
{
    ...
    public class OutwardCDNRAController : Controller
    {
        ...
        public ActionResult Save(FormCollection form)
        {
            ...
            string gstin, name, cgstin, rns, revinvoice, reviseddate, reversecharge, notetype, notenum, notedate, onotenum, onotedate, elig;
            ...
            try
            {
                ...
                onotenum = form["onotenum"];
                onotedate = form["onotedate"];
                elig = form["elig"];
                ...
                //db.Ins_Outward_Gstr1_CDNRA(name, gstin, custid, cgstin, notetype, rns, onotenum, onotedate, notenum, notedate, revinvoice, reviseddate, reversecharge, taxvalue, igstr, igsta, cgstr, cgsta, sgstr, sgsta, cessr, cessa, elig, userid);
                db.SaveChanges();
