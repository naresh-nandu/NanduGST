CREATE TABLE [dbo].[TBL_GSTR6_ISD_ELGLST_DOCLST] (
    ...
    CONSTRAINT [PK_TBL_GSTR6_ISD_ELGLST_DOCLST] PRIMARY KEY CLUSTERED ([docid] ASC),
    CONSTRAINT [FK_TBL_GSTR6_ISD_ELGLST_DOCLST_TBL_GSTR6_ISD_ELGLST] FOREIGN KEY ([elgid]) REFERENCES [dbo].[TBL_GSTR6_ISD_ELGLST] ([elgid])
);
