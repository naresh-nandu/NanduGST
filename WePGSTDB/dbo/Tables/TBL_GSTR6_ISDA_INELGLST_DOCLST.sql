CREATE TABLE [dbo].[TBL_GSTR6_ISDA_INELGLST_DOCLST] (
    ...
    CONSTRAINT [PK_TBL_GSTR6_ISDA_INELGLST_DOCLST] PRIMARY KEY CLUSTERED ([inelgdocid] ASC),
    CONSTRAINT [FK_TBL_GSTR6_ISDA_INELGLST_DOCLST_TBL_GSTR6_ISDA_INELGLST] FOREIGN KEY ([inelgid]) REFERENCES [dbo].[TBL_GSTR6_ISDA_INELGLST] ([inelgid])
);
