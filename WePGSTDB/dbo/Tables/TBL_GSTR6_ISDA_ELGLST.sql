CREATE TABLE [dbo].[TBL_GSTR6_ISDA_ELGLST] (
    ...
    CONSTRAINT [PK_TBL_GSTR6_ISDA_ELGLST] PRIMARY KEY CLUSTERED ([elgid] ASC),
    CONSTRAINT [FK_TBL_GSTR6_ISDA_ELGLST_TBL_GSTR6_ISDA] FOREIGN KEY ([isdaid]) REFERENCES [dbo].[TBL_GSTR6_ISDA] ([isdaid])
);
