...
-- exec usp_Retrieve_TRP_PAN_Details 1
-- =============================================

CREATE PROCEDURE [usp_Retrieve_TRP_PAN_Details]
	@TRPUserId int,
	@TRPId int,
	@CustId int,
	@RoleId int
...
BEGIN
	...
	Else
		Begin
			select * from TBL_Cust_PAN where  CustId = @CustId and   RowStatus = 1 and createdby = @TRPUserId
		End
END