...
Description : Procedure to Retrieve the GSTR2 CDNUR Records from the corresponding external tables
...
exec usp_Retrieve_GSTR2CDNUR_EXT 'BP','27AHQPA7588L1ZJ'
exec usp_Retrieve_GSTR2CDNUR_EXT 'POS','27AHQPA7588L1ZJ'


 */
 
CREATE PROCEDURE [dbo].[usp_Retrieve_GSTR2CDNUR_EXT]  
