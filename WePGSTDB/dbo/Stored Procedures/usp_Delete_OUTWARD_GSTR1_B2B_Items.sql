...
Description : Procedure to Delete B2B Invoice Line Item Details
...
Create PROCEDURE [usp_Delete_OUTWARD_GSTR1_B2B_Items]
		@Invid    int,
		@Retval int = null Out
...
Begin
	...
	Begin
		...
		if Exists(Select 1 From TBL_EXT_GSTR1_B2B_INV 
					...
					And rt = @Rt)
		Begin
			Update TBL_GSTR1_B2B_INV_ITMS_DET
			SET TBL_GSTR1_B2B_INV_ITMS_DET.txval = @Ntxval,
				TBL_GSTR1_B2B_INV_ITMS_DET.iamt = @Niamt,
				TBL_GSTR1_B2B_INV_ITMS_DET.camt = @Ncamt,
				TBL_GSTR1_B2B_INV_ITMS_DET.samt = @Nsamt,
				TBL_GSTR1_B2B_INV_ITMS_DET.csamt = @Ncsamt
			FROM TBL_GSTR1 t1,
				 TBL_GSTR1_B2B t2,
				 TBL_GSTR1_B2B_INV t3 ,
		...
		Begin
			Delete TBL_GSTR1_B2B_INV_ITMS_DET
			FROM TBL_GSTR1 t1,
				 TBL_GSTR1_B2B t2,
				 TBL_GSTR1_B2B_INV t3 ,
				 TBL_GSTR1_B2B_INV_ITMS t4,
		...
		SET TBL_GSTR1_B2B_INV.val = @Nval
		FROM TBL_GSTR1 t1,
			 TBL_GSTR1_B2B t2,
			 TBL_GSTR1_B2B_INV  t3 
		Where t1.gstr1id = t2.gstr1id
