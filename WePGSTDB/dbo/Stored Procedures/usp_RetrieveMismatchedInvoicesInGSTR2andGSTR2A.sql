...
exec usp_RetrieveMismatchedInvoicesInGSTR2andGSTR2A 'B2B','33GSPTN0802G1ZL'

 */

CREATE PROCEDURE [usp_RetrieveMismatchedInvoicesInGSTR2andGSTR2A]
	@CustId int,
	@UserId int,
...
BEGIN
	...
	*/
	...
	Begin
		...
		Select ROW_NUMBER() OVER(ORDER BY #TBL_Mismatched_B2B_Invs.inum2 ASC) as 'S.No', ctin2 as 'Supplier GSTIN-2', inum2 as 'Invoice No-2', idt2 as 'Invoice Date-2', val2 as 'Invoice Value-2',' ',' ', ctin2a as 'Supplier GSTIN-2A', inum2a as 'Invoice No-2A', idt2a as 'Invoice Date-2A', val2a as 'Invoice Value-2A' from #TBL_Mismatched_B2B_Invs
	...
	Begin
		...
		Select ROW_NUMBER() OVER(ORDER BY #TBL_Mismatched_CDNR_Invs.inum2 ASC) as 'S.No', ctin2 as 'Supplier GSTIN-2',nt_Num2 as 'Note No-2',nt_dt2 as 'Note Date-2', inum2 as 'Invoice No-2', idt2 as 'Invoice Date-2', val2 as 'Invoice Value-2',' ',' ', ctin2a as 'Supplier GSTIN-2A',nt_Num2a as 'Note No-2A',nt_dt2a as 'Note Date-2A', inum2a as 'Invoice No-2A', idt2a as 'Invoice Date-2A', val2a as 'Invoice Value-2A' from #TBL_Mismatched_CDNR_Invs
