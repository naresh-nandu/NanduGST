...
Description : Procedure to Delete all the GSTR1 Records from the corresponding staging area tables
...
06/06/2018  kARTHIK		Implementing Permanent Delete for both Regular and Amendment
...
CREATE PROCEDURE [usp_Delete_All_GSTR1_SA]
