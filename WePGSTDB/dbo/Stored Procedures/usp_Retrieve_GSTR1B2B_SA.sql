...
Description : Procedure to Retrieve the GSTR1 B2B Records from the corresponding staging area tables
...
exec usp_Retrieve_GSTR1B2B_SA '27AHQPA7588L1ZJ'
exec usp_Retrieve_GSTR1B2B_SA '27AHQPA7588L1ZJ'


 */
 
CREATE PROCEDURE [usp_Retrieve_GSTR1B2B_SA]  
	@GstinNo varchar(15),
	@Fp varchar(10),
	@Flag varchar(1) = Null
