...
Description : Procedure to Insert the CSV GSTR1 B2B Records to the corresponding external tables
...
exec usp_Insert_CSV_GSTR1B2B_EXT  'BP','BP001','BP,BPDV100,13AMGOH2199X398,062017,13AMGOK2199X399,INV001,01-06-2017,16000,13,N,,1,5,800,,800,800'

 */

CREATE PROCEDURE [usp_Insert_CSV_GSTR1B2B_EXT]
...
Begin
	 ...
	 Begin Try
		...
		Begin
			...
			Select 
				...
				dbo.udf_SplitGSTRRecordData(RecordContents, 12,@Delimiter) as Etin,
				dbo.udf_SplitGSTRRecordData(RecordContents, 13,@Delimiter) as Inv_Typ,
				dbo.udf_SplitGSTRRecordData(RecordContents, 14,@Delimiter) as Hsncode ,
				dbo.udf_SplitGSTRRecordData(RecordContents, 15,@Delimiter) as Hsndesc,
				dbo.udf_SplitGSTRRecordData(RecordContents, 16,@Delimiter) as Qty,
				dbo.udf_SplitGSTRRecordData(RecordContents, 17,@Delimiter) as Unitprice  ,
				dbo.udf_SplitGSTRRecordData(RecordContents, 18,@Delimiter) as Discount,
				dbo.udf_SplitGSTRRecordData(RecordContents, 19,@Delimiter) as Rt,
				dbo.udf_SplitGSTRRecordData(RecordContents, 20,@Delimiter) as Txval,
				dbo.udf_SplitGSTRRecordData(RecordContents, 21,@Delimiter) as Iamt,
				dbo.udf_SplitGSTRRecordData(RecordContents, 22,@Delimiter) as Camt,
				dbo.udf_SplitGSTRRecordData(RecordContents, 23,@Delimiter) as Samt,
				dbo.udf_SplitGSTRRecordData(RecordContents, 24,@Delimiter) as Csamt
	...
	-- Insert Records into Table TBL_EXT_GSTR1_B2B_INV
	...
	Begin Try
		...
		Select 
			gstin, fp, null, null, ctin,inum, idt, val, pos, rchrg, etin, inv_typ, 
			rt, txval, iamt, camt, samt, csamt,
			hsncode,hsndesc,qty,unitprice,discount,
