...
Date		Who			Decription 
05/18/2017	Muskan 		Initial Version
...
CREATE PROCEDURE [dbo].[usp_Insert_JSON_GSTR6B2BA_EXT]
...
Begin
	...
	Begin
		...
		From
		(
			Select distinct gstin,fp,ctin,inum,idt,t.oinum,t.oidt,val
			From #TBL_EXT_GSTR6_B2BA_INV
			group by gstin,fp,ctin,inum,idt,oinum,oidt,val
		 ) t
		...
		Begin Try
			...
			(	gstin, fp, ctin,inum, idt, oinum,oidt,val, pos,  
