...
Description : Procedure to Insert the GSTR6A CDN JSON Records to the corresponding external tables
...
exec usp_Insert_JSON_GSTR6CDNA_EXT  'POS',
 */

CREATE PROCEDURE [dbo].[usp_Insert_JSON_GSTR6CDNA_EXT]
...
Begin
	...
	Select @TotalRecordsCount = count(*) from #TBL_EXT_GSTR6_CDNA
	...
	Begin
		...
		Update #TBL_EXT_GSTR6_CDNA -- Introduced due to Excel Format Issue
		...
		Begin Try
			...
			Insert TBL_EXT_GSTR6_CDNA
			(	gstin, fp, ctin, ntty, nt_num, nt_dt,ont_num, ont_dt, 
				inum, idt,val,  
	...
	Select @ErrorRecords = (Select * From #TBL_EXT_GSTR6_CDNA
							Where IsNull(ErrorCode,0) <> 0
							FOR JSON AUTO)
