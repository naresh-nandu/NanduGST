...
Description : Procedure to Retrieve the GSTR1_D B2CS Records from the corresponding staging area tables
...
exec usp_Retrieve_GSTR1_D_B2CS_SA


 */
 
CREATE PROCEDURE [usp_Retrieve_GSTR1_D_B2CS_SA]  
	@Gstin varchar(15),
	@Fp varchar(10)
...
Begin
	...
	Select
		...
		csamt
	From TBL_GSTR1_D t1
	Inner Join TBL_GSTR1_D_B2CS t2 On t2.gstr1did = t1.gstr1did
	Where gstin = @Gstin
	And fp = @Fp
