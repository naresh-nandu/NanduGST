...
exec usp_Retrieve_GSTR2TXI_EXT 'BP','27AHQPA7588L1ZJ'
exec usp_Retrieve_GSTR2TXI_EXT 'POS','27AHQPA7588L1ZJ'


 */
 
CREATE PROCEDURE [dbo].[usp_Retrieve_GSTR2TXI_EXT]  
...
Begin
	...
	Select
		ROW_NUMBER() OVER(ORDER BY txiid desc) AS 'SNo',
		txiid,
		gstin,
		fp,
		pos,
