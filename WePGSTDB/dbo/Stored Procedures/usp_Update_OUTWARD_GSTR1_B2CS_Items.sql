...
Description : Procedure to Update  B2CS Invoice Line Item Details
				
Written by  : Karthik.kanniyappan@wepindia.com

Date		Who			Decription 
11/12/2017	Karthik		Initial Version
...
exec usp_Update_OUTWARD_GSTR1_B2CS_Items 
 */
 
CREATE PROCEDURE [usp_Update_OUTWARD_GSTR1_B2CS_Items]
		@Invid    int,
		@Hsncode	varchar(50),
		@Hsndesc	varchar(50),
		@Qty	decimal(18,2),
...
Begin
	...
	Declare @Gstinid int, @Gstr1id int, @B2csid int, @InvoiceId int, @Flag varchar(1)
