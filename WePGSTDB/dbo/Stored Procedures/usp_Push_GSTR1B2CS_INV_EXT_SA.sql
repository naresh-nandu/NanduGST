...
Description : Procedure to Insert the External GSTR1 B2CS INV Records to the corresponding Staging
				Area tables
...
12/13/2017	Seshadri	Fixed Integration Testing defects
12/22/2017	Seshadri	Made code changes to include supply type in the where clause
...
exec usp_Push_GSTR1B2CS_INV_EXT_SA  'POS','POSDEV1', '27AHQPA7588L1ZJ'

 */

CREATE PROCEDURE [usp_Push_GSTR1B2CS_INV_EXT_SA]
...
Begin
	...
	t1.sply_typ as sply_ty,
	t1.typ,t1.etin,t1.pos,
	t1.rt, t1.txval, 
	...
	(
		...
		Group By gstin,fp,gt,cur_gt,sply_typ,typ,etin,pos,rt
	)t1
	Cross Apply 
	(
	...
	Set	txval = IsNull(t1.txval,0) + IsNull(t2.txval,0), 
