...
Begin
	...
	if exists (select 1 from userlist where roleid = @RoleId )
		begin
	...
	Else
		Begin
			 delete from MAS_Roles_Resources where FK_Role_Resource_Role_ID = @RoleId 
			 delete from MAS_Roles where role_id = @RoleId
