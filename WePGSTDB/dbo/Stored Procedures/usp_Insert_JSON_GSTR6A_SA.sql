...
exec usp_Insert_JSON_GSTR6A_SA  'POS',
 */

CREATE PROCEDURE [dbo].[usp_Insert_JSON_GSTR6A_SA]
	@Gstin varchar(15),
	@Fp varchar(10), 
...
Begin
	...
	Begin
		exec usp_Insert_JSON_GSTR6AB2B_SA @Gstin, @Fp, @B2b
	End

	If Ltrim(Rtrim(IsNull(@Cdnr,''))) <> ''
	Begin
		exec usp_Insert_JSON_GSTR6ACDNR_SA @Gstin, @Fp, @Cdnr
	End
